...
int main(int argc, char **argv)
{
    ...
    cxxrtl_design::p_PdmTestTop top;
    ...
    cxxrtl::debug_item pdm_clk      = all_debug_items.at("pdm_clk");
    cxxrtl::debug_item pdm_dat      = all_debug_items.at("pdm_dat");
    ...
    */
    ...
    while(!end_of_sim){
        ...
        if (pdm_clk_prev != *pdm_clk.curr){
            if (*pdm_clk.curr == 0){
                *pdm_dat.curr = pdm_value;
                pdm_value ^= 1;
            }
        }
        pdm_clk_prev = *pdm_clk.curr;
